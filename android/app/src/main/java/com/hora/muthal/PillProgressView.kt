...
class PillProgressView @JvmOverloads constructor(
    ...
    var progressColor: Int = com.hora.muthal.util.ThemeHelper.getPrimaryColor(context)
        set(value) {
            field = value
            invalidate()
        }
    ...
    var trackColor: Int = com.hora.muthal.util.ThemeHelper.getSurfaceVariantColor(context)
        set(value) {
            field = value

#!/usr/bin/env bash
#
# sync_shared_android.sh — TEMPLATE. Copy into an app as android/tools/sync_shared_android.sh
# and set APP_PKG (and the roots if they differ). Copies shared Android source + resources
# from the local hora-core checkout into the app, rewriting the Kotlin package placeholder.
#
...
#
# Run from the app's repo root:  bash android/tools/sync_shared_android.sh
#
set -euo pipefail
...
APP_PKG="${APP_PKG:-com.hora.muthal}"
